...
import 'package:angular2/angular2.dart' show Component, ContentChildren, ControlGroup, Directive, FORM_DIRECTIVES, Input, Output, QueryList, View;
...
class BsTabs {
  @ContentChildren(BsPane) QueryList<BsPane> panes;
}
