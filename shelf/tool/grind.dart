...
void analyze(GrinderContext context) {
  final files = [];
   ['lib', 'tool', 'bin'].forEach((dir) => files.addAll(
...
@Task()
@Depends(init)
void testsWeb(GrinderContext context) {
  Tests.runWebTests(context, directory: 'web', htmlFile: 'web.html');
}
